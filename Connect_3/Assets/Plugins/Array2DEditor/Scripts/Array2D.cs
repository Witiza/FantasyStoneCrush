...
namespace Array2DEditor
{
    ...
    public abstract class Array2D<T>
    {
        ...
        //This is done like this so the starting point of the array will be on the bottom left. The solucion should be more elegant tho
        public T GetCell(int x, int y)
        {
            return GetCellRow(GridSize.y - y-1)[x];
        }
        
        public void SetCell(int x, int y, T value)
        {
            GetCellRow(GridSize.y-y-1)[x] = value;
        }
