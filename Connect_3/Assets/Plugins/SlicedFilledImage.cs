				...
				case FillDirection.Right:
					{
						...
						if (width < border.x)
						{
							s_SlicedVertices[1].x = s_SlicedVertices[3].x;
							s_SlicedVertices[2].x = s_SlicedVertices[3].x;
						}
						else if (width < border.x + border.z)
						{
							s_SlicedVertices[1].x = border.x;
				...
				case FillDirection.Left:
					{
						...
						if (width < border.x)
						{
							s_SlicedVertices[1].x = s_SlicedVertices[0].x;
							s_SlicedVertices[2].x = s_SlicedVertices[0].x;
						}
						else if (width < border.x + border.z)
						{
				...
				case FillDirection.Up:
					{
						...
						if (height < border.y)
						{
							s_SlicedVertices[1].y = s_SlicedVertices[3].y;
							s_SlicedVertices[2].y = s_SlicedVertices[3].y;
						}
						else if (height < border.y + border.w)
						{
							s_SlicedVertices[1].y = border.y;
				...
				case FillDirection.Down:
					{
						...
						if (height < border.y)
						{
							s_SlicedVertices[1].y = s_SlicedVertices[0].y;
							s_SlicedVertices[2].y = s_SlicedVertices[0].y;
						}
						else if (height < border.y + border.w)
						{
